...
Route::group(['prefix' => 'hsc_result', 'as' => 'hsc_result.', 'namespace' => 'Hsc_result', 'middleware' => 'auth'], function () {
  ...
  Route::get('/fees_details', ['as' => 'fees_details', 'uses' => 'HscResultController@fees_details']);
  Route::post('/fees_details/store', ['as' => 'fees_details.store', 'uses' => 'HscResultController@fees_details_store']);
