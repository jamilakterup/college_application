  ...
  // var current_level = $('#current_level').val();
    if(roll =='')
    {
      ...
      //alert(response);
          ...
          if(status==0 )
          {
               $('#next_step_error').html('<span style="color:red;">Registration Not Open');
               $('#information').hide();
      ...
      if(status==3){
          $('#next_step_error').html('<span style="color:red;">Dgree Registration is not opened.');
               $('#information').hide();
      }
      if(status==4){
          $('#next_step_error').html('<span style="color:red;">Dgree Registration date is expired.');
               $('#information').hide();
      }
      if(status==7){
      ...
      if(status==6){
          var url ='Private/dbblapplication';
          window.location=url;
      }
