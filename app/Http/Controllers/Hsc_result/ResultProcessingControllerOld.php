	...
	public function store(Request $request) {
		...
		if ($request->isMethod('post'))
		{
				...
				foreach($student_infos as $student_info){
					try {
						...
						{					
							...
							$subject_particals = SubjectParticle::where('classe_id',$current_level)->where('group_id',$group_id)->where('subject_id',$student_sub[0]->sub1_id)->get();
							$sub_total_mark=0;
						...
						{					
							...
							$subject_particals = SubjectParticle::where('classe_id',$current_level)->where('group_id',$group_id)->where('subject_id',$student_sub[0]->sub2_id)->get();
							$sub_total_mark=0;
							$sub_total_convert =100;
							foreach ($subject_particals as  $subject_partical) {
								$sub_total_mark=$subject_partical->total;
						...
						{					
							...
							$subject_particals = SubjectParticle::where('classe_id',$current_level)->where('group_id',$group_id)->where('subject_id',$student_sub[0]->sub3_id)->get();
							$sub_total_mark=0;
							$sub_total_convert =100;
							foreach ($subject_particals as  $subject_partical) {
								$sub_total_mark=$subject_partical->total;
						...
						{					
							...
							$subject_particals = SubjectParticle::where('classe_id',$current_level)->where('group_id',$group_id)->where('subject_id',$student_sub[0]->sub4_id)->get();
							$sub_total_mark=0;
							$sub_total_convert =100;
							foreach ($subject_particals as  $subject_partical) {
								$sub_total_mark=$subject_partical->total;
						...
						{					
							...
							$subject_particals = SubjectParticle::where('classe_id',$current_level)->where('group_id',$group_id)->where('subject_id',$student_sub[0]->sub5_id)->get();
							$sub_total_mark=0;
							$sub_total_convert =100;
							foreach ($subject_particals as  $subject_partical) {
								$sub_total_mark=$subject_partical->total;
						...
						{					
							...
							$subject_particals = SubjectParticle::where('classe_id',$current_level)->where('group_id',$group_id)->where('subject_id',$student_sub[0]->sub6_id)->get();
							$sub_total_mark=0;
							$sub_total_convert =100;
							foreach ($subject_particals as  $subject_partical) {
								$sub_total_mark=$subject_partical->total;
						...
						{					
							...
							$subject_particals = SubjectParticle::where('classe_id',$current_level)->where('group_id',$group_id)->where('subject_id',$student_sub[0]->sub21_id)->get();
							$sub_total_mark=0;
							$sub_total_convert =100;
							foreach ($subject_particals as  $subject_partical) {
								$sub_total_mark=$subject_partical->total;
						...
						{					
							...
							$subject_particals = SubjectParticle::where('classe_id',$current_level)->where('group_id',$group_id)->where('subject_id',$student_sub[0]->sub22_id)->get();
							$sub_total_mark=0;
							$sub_total_convert =100;
							foreach ($subject_particals as  $subject_partical) {
								$sub_total_mark=$subject_partical->total;
						...
						{					
							...
							$subject_particals = SubjectParticle::where('classe_id',$current_level)->where('group_id',$group_id)->where('subject_id',$student_sub[0]->sub23_id)->get();
							$sub_total_mark=0;
							$sub_total_convert =100;
							foreach ($subject_particals as  $subject_partical) {
								$sub_total_mark=$subject_partical->total;
						...
						{					
							...
							$subject_particals = SubjectParticle::where('classe_id',$current_level)->where('group_id',$group_id)->where('subject_id',$student_sub[0]->sub24_id)->get();
							$sub_total_mark=0;
							$sub_total_convert =100;
							foreach ($subject_particals as  $subject_partical) {
								$sub_total_mark=$subject_partical->total;
						...
						{					
							...
							$subject_particals = SubjectParticle::where('classe_id',$current_level)->where('group_id',$group_id)->where('subject_id',$student_sub[0]->sub25_id)->get();
							$sub_total_mark=0;
							$sub_total_convert =100;
							foreach ($subject_particals as  $subject_partical) {
								$sub_total_mark=$subject_partical->total;
						...
						{					
							...
							$subject_particals = SubjectParticle::where('classe_id',$current_level)->where('group_id',$group_id)->where('subject_id',$student_sub[0]->sub26_id)->get();
							$sub_total_mark=0;
							$sub_total_convert =100;
							foreach ($subject_particals as  $subject_partical) {
								$sub_total_mark=$subject_partical->total;
						...
						{					
							...
							$subject_particals = SubjectParticle::where('classe_id',$current_level)->where('group_id',$group_id)->where('subject_id',$student_sub[0]->fourth_id)->get();
							$sub_total_mark=0;
							$sub_total_convert =100;
							foreach ($subject_particals as  $subject_partical) {
								$sub_total_mark=$subject_partical->total;
						...
						{					
							...
							$subject_particals = SubjectParticle::where('classe_id',$current_level)->where('group_id',$group_id)->where('subject_id',$student_sub[0]->fourth2_id)->get();
							$sub_total_mark=0;
							$sub_total_convert =100;
							foreach ($subject_particals as  $subject_partical) {
								$sub_total_mark=$subject_partical->total;
			...
			else
			{
				...
				$check=HscRsltProcessing::whereExam_year($exam_year)->whereGroup_id($group_id)->whereExam_id($exam_id)->where('session', $session)->get();
				if($check->count()>0):
					$error_message =$check[0]->exam_year.' '.$check[0]->group->name.' '.$check[0]->exam->name.' Already Generated';
					return Redirect::back()->withInput()->with('error',$error_message);
				endif;
				$student_infos = StudentInfoHsc::whereCurrent_level($curr_level->name)->where('session',$session)->whereGroups($group_name->name)->orderBy('id')->get();
				...
				foreach($student_infos as $student_info) :
					try{
							...
							if(count($marks) > 0):
								...
								if($ab_sub1==0):
									if($sub1_fail!=1):
										...
										$insert->exam_id=$exam_id;
										$insert->subject_id=$student_sub[0]->sub1_id;
										$insert->total_mark=$total_obt_sub1;
										$insert->grade=$g_and_p['grade'];
										$insert->point=$g_and_p['point'];
										$insert->fourth=0;
										$insert->save();
						...
						$all_sub_mark=StudentSubMarkGp::whereStudent_id($student_info->id)->where('session',$session)->whereExam_year($exam_year)->whereGroup_id($group_id)->whereExam_id($exam_id)->get();
