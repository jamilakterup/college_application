...
{
    // Show View Page (Read Only)
    public function view($user_id)
    {
        $info = GraduatedStudentInfo::where('user_id', $user_id)->first();

        if (!$info) {
            return redirect()->route('graduated_student.form');
        }

        return view('graduated-student.view', compact('info'));
    }
    ...
    public function edit($user_id)
    {
        ...
        return view('graduated-student.edit', compact('info'));
    }


    // Show Create / Main Form
    ...
    public function store(Request $request)
    {
        ...
        return redirect()
            ->route('graduated_student.view', ['user_id' => $newUserId])
