...
class ReportController extends Controller
{
    ...
    public function generateHonAdmReport(Request $request){
        ...
        if($request->get('type') =='csv'){
            ...
            foreach($admissions as $val){
                $data[] = [
                  $val->id,$val->class_roll,$val->name,$val->father_name,$val->mother_name,$val->birth_date,$val->admission_roll,$val->faculty_name,$val->dept_name,$val->contact_no,$val->current_level,$val->session
                ];
            }
    ...
    public function generateMscAdmReport(Request $request){
        ...
        if($request->get('type') =='csv'){
            ...
            foreach($admissions as $val){
                ...
                $data[] = [
                  $val->id,$val->class_roll,$val->name,$val->father_name,$val->mother_name,$val->birth_date,$val->admission_roll,$val->faculty_name, $val->dept_name,$val->contact_no,$val->session
                ];
            }
  ...
  public function generateMscAppReport(Request $request){
    ...
    if($request->get('type') =='csv'){
        ...
        foreach($applications as $val){
            $data[] = [
              $val->admission_roll,$val->name,$val->contact_no,$val->dept_name,$val->session,$val->total_amount,$val->date
            ];
        }
    ...
    public function generateDegAdmReport(Request $request){
        ...
        if($request->get('type') =='csv'){
            ...
            foreach($admissions as $val){
                ...
                $data[] = [
                  $val->id,$val->class_roll,$val->name,$val->father_name,$val->mother_name,$val->birth_date,$val->admission_roll,$val->groups,$val->contact_no,$val->session
                ];
            }
  ...
  public function generateHsc2ndAdmReport(Request $request){
    ...
    if($request->get('type') =='csv'){
        ...
        foreach($records as $val){
            $data[] = [
              $val->id,$val->name,$val->groups,$val->session,$val->total_amount,$val->date
            ];
        }
