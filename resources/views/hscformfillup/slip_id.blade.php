...
<body>
    <div class="slip">
        ...
        <section class="main-content">
            <h2 style="margin: 2px 0;">HSC Examination-{{$ff_student->exam_year}} Form Fill-up Confirmation Slip</h2>
            <table>
                <tr>
                ...
                <tr>
                    <td class="info-label">Groups</td>
                    <td>{{$ff_student->groups}}</td>
                </tr>

                @if($ff_student->formfillup_type)
                    <tr>
                        <td class="info-label">Form Fillup Type</td>
                        <td>{{ucfirst($ff_student->formfillup_type)}}</td>
                    </tr>
                @endif
                <tr>
                    <td class="info-label">Slip Name</td>
