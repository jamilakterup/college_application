                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
                        <div class="card bg-info text-white">
                            <div class="card-body">
                                ...
                                <i class="fas fa-file-alt fa-2x position-absolute"
                                    style="right: 15px; top: 15px; opacity: 0.7;"></i>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
                        <div class="card bg-warning text-white">
                            <div class="card-body">
                                ...
                                <i class="fas fa-clock fa-2x position-absolute"
                                    style="right: 15px; top: 15px; opacity: 0.7;"></i>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
                        <div class="card bg-primary text-white">
                            <div class="card-body">
                                ...
                                <i class="fas fa-money-bill-wave fa-2x position-absolute"
                                    style="right: 15px; top: 15px; opacity: 0.7;"></i>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 col-sm-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control datepickr" id="date-from" name="date_from"
                                ...
                                <div class="col-md-3 col-sm-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control datepickr" id="date-to" name="date_to"
                                ...
                                <div class="col-md-3 col-sm-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control selectize" id="level-filter" name="level"
                                ...
                                <div class="col-md-3 col-sm-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="group-filter" name="group_dept"
                                ...
                                <div class="col-md-3 col-sm-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="department-filter" name="dept"
                                ...
                                <div class="col-md-3 col-sm-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        {!! Form::select('academic_session', selective_multiple_session(), null, [
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#export-btn').click(function() {
                ...
                $btn.html('<i class="fas fa-spinner fa-spin mr-1"></i> Exporting...').prop('disabled',
                true);
                ...
                $.ajax({
                    ...
                    window.location.href = '{{ route('student.fees-payment-report.export') }}?' +
                        params.toString();
        ...
        `;
            ...
            $('#status-filter, #date-from, #date-to, #level-filter, #group-filter', '#department-filter',
                '#session-filter').on('change', debounce(function() {
                table.ajax.reload();
                loadSummary();
            }, 500));
        ...
        `);
            ...
            $(document).on('click', '.print-details', function() {
                var applicationId = $(this).data('id');
                window.open('{{ route('fees-payment.download-slip') }}?application_id=' + applicationId,
                    '_blank');
            });
