...
@section('page-title', 'Masters Application List')
...
<div class="panel">
        <div class="panel-body">
        	...
        	<div class="col-md-12 d-flex justify-content-center">
				...
				{!! Form::open(['route'=> 'student.application.masters', 'method'=> 'post', 'class' => 'form-inline']) !!}
			...
			<div class="d-flex justify-content-between">
				...
				{!! Form::open(['route' => 'student.application.mastersAppreport', 'method'=> 'post', 'target' => '_blank']) !!}
