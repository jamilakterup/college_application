...
@if ($category != '')
    {!! Form::select('faculty', $faculty, null, [
        'class' => 'small_form_element form-control form-control-sm',
        'id' => $faculty_js_id,
    ]) !!}
    <span id="dept"></span>
    {!! Form::select('level', $level, null, ['class' => 'small_form_element form-control form-control-sm']) !!}
    {!! Form::select('session', selective_multiple_session(), null, [
        'class' => 'small_form_element form-control form-control-sm',
        'id' => 'session',
    ]) !!}
    {!! Form::select('type', ['1' => 'Front', '2' => 'Back'], null, [
        'class' => 'small_form_element form-control form-control-sm',
        'id' => 'type',
    ]) !!}
@endif
