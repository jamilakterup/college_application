...
<title>Honours Form Fillup Student Lists, Exam Year-{{$exam_year}}</title>
</head>
<body>
<style>
.page-break {
...
<h2 style="text-align: center;">Honours Form Fillup Student Lists</h2>
...
<?php $si=0; ?>
	<?php foreach($form_fillup as $college) {?>
				...
				<tr class="">
					...
					<td style="font-size:12px;"><?php echo $college->name ?></td>
					...
					<td style="font-size:12px;"><?php echo $college->date ?></td>		
				</tr>	
