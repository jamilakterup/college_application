...
<table border="1">
	...
	<thead>
		...
		<tr>
			<td style="text-align: center; color: #C00000; font-size: 15px; font-weight: bold;" colspan="{{$head_colspan}}">{{$request->current_level ?? 'Degree'}} Admission {{$request->session}}</td>
		</tr>
		<tr>
