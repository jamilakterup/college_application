...
<table border="1">
	...
	<tbody border="1">
		...
		@foreach ($departments as $key =>  $dept)
			@php
				$dept_students = DB::table('form_fillup')->whereIn('id', $student_ids)->where('level_study', $request->current_level)->where('exam_year', $request->exam_year)->where('dept_name', $dept)->get();
