...
@section('page-title', 'Masters Admission Report Management')
...
<div class="panel">
	<div class="panel-body">
		...
		{!! Form::open(['route'=> 'report.masters.admission', 'method'=> 'post', 'class' => 'form-inline d-flex justify-content-center']) !!}
		...
		<div class="form-group">
			{!! Form::select('current_level', selective_multiple_masters_level(), $current_level ?? null, ['class'=>'form-control form-control-sm current_level selectize', 'autocomplete'=> 'off']) !!}
		</div>
		...
		<div class="d-flex justify-content-end">
			{!! Form::open(['route' => 'report.masters.admission.generate', 'method'=> 'post', 'target' => '_blank']) !!}
			{!! Form::hidden('id', $id) !!}
	...
	{{-- end masters_admission_index permission--}}
	@endcan
