        ...
        <div class="panel-body">
            ...
            @can('hsc.admission.index')
                ...
                <div class="form-group">
                    {!! Form::text('registraion_id', $registraion_id, [
                ...
                <div class="form-group">
                    {!! Form::select('groups', selective_faculties(), $groups, [
                        'class' => 'form-control form-control-sm group selectize',
                        'autocomplete' => 'off',
                    ]) !!}
                ...
                <div class="form-group">
                    {!! Form::select('current_level', selective_multiple_hsc_level(), $current_level, [
                        'class' => 'form-control form-control-sm current_level selectize',
                        'autocomplete' => 'off',
                        'required' => true,
                    ]) !!}
                </div>
                ...
                <div class="form-group">
                    {!! Form::select('session', selective_multiple_session(), $session, [
                        'class' => 'form-control form-control-sm session selectize',
                        'autocomplete' => 'off',
                    ]) !!}
                ...
                <div class="form-group">
                    {!! Form::select('formfillup_type', selective_formfillup_type(), $formfillup_type, [
                        'class' => 'form-control form-control-sm formfillup_type selectize',
                        'autocomplete' => 'off',
                    ]) !!}
                ...
                <div class="form-group">
                    {!! Form::select('exam_year', selective_multiple_exam_year(), $exam_year, [
                        'class' => 'form-control form-control-sm exam_year selectize',
                        'autocomplete' => 'off',
                        'required' => true,
                    ]) !!}
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="reportDropdown" role="menu">
                            ...
                            <button class="dropdown-item" name="type" type="submit" value="csv"><i
                                    class="fas fa-file-csv"></i> Student CSV</button>

                            <button class="dropdown-item" name="type" type="submit" value="report_excel"><i
                                    class="fas fa-file-spreadsheet"></i> Indivisual/Consulated/Groups</button>
                        </div>
                    </div>
                    {!! Form::close() !!}
                </div>
