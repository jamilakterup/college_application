...
<div class="panel">
        <div class="panel-body">
        	...
        	<div class="d-flex justify-content-between">
        		<button class="btn btn-primary" data-target="#filter-modal" data-toggle="modal" type="button"><i class="fas fa-filter"></i> Filter HSC Admission Report</button>
			...
			@if($id != '' || $groups !='' || $gender !='' ||  $current_level!='' || $session!='' || $from_date !='' || $to_date !='')
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        {!! Form::open(['route'=> 'report.hsc.admission', 'method'=> 'post', 'class' => 'form-horizontal']) !!}
				  ...
				  <div class="form-group">
				    {!! Form::select('gender', selective_gender_list(), $gender, ['class'=>'form-control group', 'autocomplete'=> 'off']) !!}
							{!!invalid_feedback('gender')!!}
				  </div>

				  <div class="form-group">
				    {!! Form::select('current_level', $current_level_lists, $current_level, ['class'=>'form-control group', 'autocomplete'=> 'off']) !!}
