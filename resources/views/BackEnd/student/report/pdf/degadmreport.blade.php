...
<title>Degree Admission Student Lists, Session-{{$session}}</title>
</head>
<body>
<style>
.page-break {
...
<h2 style="text-align: center;">Degree Admission Student Lists {{$session !='' ? 'Session: '.$session:''}}</h2>
...
<?php $si=0; ?>
	<?php foreach($admissions as $adm) {?>
				@php
					$admitted_student = DB::table('deg_admitted_student')->where('auto_id', $adm->refference_id)->get();
				@endphp
				<tr class="">
