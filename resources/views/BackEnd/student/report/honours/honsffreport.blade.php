...
@section('page-title', 'Honours Formfillup Report Management')
...
<div class="panel">
        <div class="panel-body">
			...
			{!! Form::open(['route'=> 'report.honours.ff', 'method'=> 'post', 'class' => 'form-inline d-flex justify-content-center']) !!}
        ...
        <div class="form-group">
          {!! Form::select('faculty', selective_faculties(), $faculty, ['class'=>'form-control form-control-sm faculty selectize', 'autocomplete'=> 'off']) !!}
        ...
        <div class="form-group">
				    {!! Form::select('current_level', selective_multiple_honours_level(), $current_level, ['class'=>'form-control form-control-sm current_level selectize', 'autocomplete'=> 'off', 'required' => true]) !!}
        </div>
      ...
      {!! Form::close() !!}
        	...
        	{!! Form::open(['route' => 'report.honours.ff.generate', 'method'=> 'post', 'target' => '_blank']) !!}
						{!! Form::hidden('registraion_id', $registraion_id) !!}
            ...
            <div class="dropdown-menu" aria-labelledby="reportDropdown" role="menu">
              ...
              <button class="dropdown-item" name="type" type="submit" value="report_excel"><i class="fas fa-file-spreadsheet"></i> Indivisual/Consulated/Dept</button>
            </div>
          </div>
					{!! Form::close() !!}
        </div>
