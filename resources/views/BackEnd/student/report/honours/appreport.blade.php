...
@section('page-title', 'Honours Application Report Management')
...
<div class="panel">
        <div class="panel-body">
			...
			@can('honours.admission.index')
				{!! Form::open(['route'=> 'report.honours.application', 'method'=> 'post', 'class' => 'form-inline d-flex justify-content-center']) !!}
        ...
        <div class="form-group">
          {!! Form::select('exam_year', selective_multiple_exam_year(), $exam_year ?? null, ['class'=>'form-control form-control-sm exam_year selectize', 'autocomplete'=> 'off']) !!}
        ...
        <div class="form-group">
            ...
            <div class="input-group mb-2">
              ...
              {!! Form::text('from_date', $from_date ?? null, ['class'=> 'form-control form-control-sm', 'placeholder' => 'From Date', 'autocomplete'=> 'off']) !!}
            </div>
            <div class="input-group">
              <span class="input-group-addon">to</span>
              {!! Form::text('to_date', $to_date ?? null, ['class'=> 'form-control form-control-sm', 'placeholder' => 'To Date', 'autocomplete'=> 'off']) !!}
            </div>
          </div>
			  </div>
      ...
      {!! Form::close() !!}
        ...
        @if($exam_year!='' || $session!='' || $from_date !='' || $to_date !='' || $admission_roll!='')
        	...
        	{!! Form::open(['route' => 'report.honours.application.generate', 'method'=> 'post', 'target' => '_blank']) !!}
  ...
  <div class="modal-dialog modal-simple">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Filter Honours Admission Report</h4>
      </div>
      <div class="modal-body">
        {!! Form::open(['route'=> 'report.honours.application', 'method'=> 'post', 'class' => 'form-horizontal']) !!}
		  		<div class="form-group">
