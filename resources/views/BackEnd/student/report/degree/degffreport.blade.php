...
@section('page-title', 'Degree Formfillup Report Management')
...
<div class="panel">
        <div class="panel-body">
			...
			{!! Form::open(['route'=> 'report.degree.ff', 'method'=> 'post', 'class' => 'form-inline d-flex justify-content-center']) !!}
        ...
        <div class="form-group">
				    {!! Form::select('current_level', selective_multiple_degree_level(), $current_level, ['class'=>'form-control form-control-sm current_level selectize', 'autocomplete'=> 'off', 'required' => true]) !!}
        </div>
      ...
      {!! Form::close() !!}
        	...
        	{!! Form::open(['route' => 'report.degree.ff.generate', 'method'=> 'post', 'target' => '_blank']) !!}
