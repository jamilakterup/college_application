{!! Form::open(['route'=> 'students.honours.store', 'method' => 'post', 'files'=> true, 'data-form'=> 'postForm']) !!}
...
<div class="row mb-3">
	<div class="col-lg-6">
		...
		<div class="form-group">
			...
			{!! Form::select('current_level', selective_multiple_honours_level(), $student->current_level ?? null, ['class' => 'form-control', 'required'=> true]) !!}
			<div class="invalid-feedback"></div>
		</div>	
		<div class="form-group">
		...
		<table class="table table-striped table-responsive table-bordered">
			...
			<tbody>
				<tr>
					...
					<td>
						{!! Form::text('ssc_reg', $student->ssc_reg ?? null, ['class'=> 'form-control', 'placeholder'=> 'SSC REG']) !!}
						<div class="invalid-feedback"></div>
					</td>
					<td>
				...
				<tr class="success">
					...
					<td>
						{!! Form::text('hsc_reg', $student->hsc_reg ?? null, ['class'=> 'form-control', 'placeholder'=> 'HSC REG']) !!}
						<div class="invalid-feedback"></div>
					</td>
					<td>
