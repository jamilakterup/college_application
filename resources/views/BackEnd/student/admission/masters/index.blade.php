...
@section('page-title', 'Masters Student Management')
...
<div class="panel">
  <div class="panel-body">
      ...
      <div class="form-group">
        ...
        <div class="form-group">
          {!! Form::select('current_level', selective_multiple_masters_level(), $current_level ?? null, ['class'=>'form-control group filter selectize', 'autocomplete'=> 'off', 'id'=> 'current_level', 'data-option'=> '--Select Level--']) !!}
        </div>
...
<div class="card">
  <div class="card-header d-flex justify-content-between bg-light">
    ...
    <div class="mt-3">
      ...
      @include('BackEnd.student.admission.masters.particles.subMenu')
      @can('student.masters.create')
        <a href="{{route('students.masters.create')}}" class="btn btn-primary add_new" data-label="Masters Student">Add A New Student</a>
      @endcan
    </div>
...
<script>
    $(document).ready(function() {
      datatable = $('#datatable').DataTable({
          ajax:{
            url: "{{ route('students.masters.datasource') }}",
            data: function (d) {
              d._token = "{{ csrf_token() }}",
          ...
          columns: [
            ...
            { data: "session"},
            { data: "hons_roll", visible: false},
            { data: "hons_subject", visible: false},
...
@include('BackEnd.common.checkbox_row_action', ['route'=> route('students.masters.force_promotion')]);
@endpush