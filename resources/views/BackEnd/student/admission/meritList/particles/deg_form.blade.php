<form class='form-horizontal' action="{{route('student.meritlist.degree.store', ['type'=> 'degree_probable'])}}" data-form='postForm'>
  <div class="row">
      <div class="col-sm-6">
        ...
        <div class="form-group">
          {{ Form::label('groups', 'Groups', ['class' => 'col-form-label']) }}
            {!! Form::select('groups', filter_empty_array(selective_degree_subjects()), $groups ?? null, ['class'=>'form-control selectize','placeholder', 'data-plugin'=> 'selectpicker']) !!}
            <div class='invalid-feedback'></div>
        </div>
