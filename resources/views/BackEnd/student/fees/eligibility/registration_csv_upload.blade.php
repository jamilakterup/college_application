...
@section('page-title', 'CSV Registration Update')
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="alert alert-info">
                    ...
                    <ul class="mb-0">
                        <li>The CSV file should contain the following columns: <code>student_id, registration_id</code></li>
                        <li>The first row should contain column headers</li>
                        <li><code>student_id</code> is required and must exist in the selected student type</li>
                        <li><code>registration_id</code> is required and will update the student's registration number</li>
                ...
                <div class="bg-light p-3 border rounded">
                    <pre>student_id,registration_id
1,REG001
2,REG002
3,REG003</pre>
                </div>
        ...
        <div class="card" id="progress-card" style="display: none;">
            ...
            <div class="card-body">
                ...
                <p class="text-muted">Please wait while we update registration numbers...</p>
            </div>
        </div>
        ...
        <div class="card" id="results-card" style="display: none;">
            <div class="card-header">
                <h3 class="card-title">
                    <i class="fas fa-check-circle mr-2"></i> Update Results
                </h3>
            </div>
            <div class="card-body">
...
$(document).ready(function() {
    ...
    $('#csv-upload-form').on('submit', function(e) {
        ...
        $.ajax({
            url: '{{ route("student.registration.csv-upload.process") }}',
            method: 'POST',
            data: formData,
            processData: false,
            contentType: false,
        ...
        if (details.successful > 0) {
            html += `
                <div class="alert alert-success mt-3">
                    ...
                    Successfully updated ${details.successful} student registration numbers.
                </div>
            `;
        }
