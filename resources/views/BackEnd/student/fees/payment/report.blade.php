                        ...
                        <div class="row">
                            <div class="col-md-3 col-sm-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="student-type-filter" name="student_type" aria-label="Filter by student type">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <button type="button" class="btn btn-success btn-sm" id="export-btn-header">
...
$(document).ready(function() {
    ...
    var table = $('#fees-payment-table').DataTable({
        ...
        ajax: {
            ...
            data: function(d) {
                ...
                d.level = $('#student-type-filter').val();
    ...
    $('#export-btn-header').click(exportCSV);
            ...
            <div class="info-card">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <span class="detail-value">${data.registration_id || 'N/A'}</span>
                    </div>
                </div>
            </div>
