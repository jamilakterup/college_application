...
@section('page-title', 'Masters Probable List Student Management')
...
<div class="panel">
	<header class="panel-heading">
	  <h3 class="panel-title">Upload Masters Probable List From CSV</h3>
	</header>
	...
	<div class="panel-body">
		...
		<div class="header-menu mb-5 d-flex justify-content-start">
			...
			{!! Form::hidden('type', 'mscff') !!}
			<button class="btn btn-danger delete mr-1" type="submit"><i class="fas fa-trash"></i> Delete</button>
			{!! Form::close() !!}
			
    		<a href="{{route('download.csv.format', ['type'=> 'mscff'])}}" class="btn btn-info"><i class="fas fa-file-csv"></i> Download Format</a>
		...
		<div class="row">
		  <div class="col-md-12">
	          	...
	          	{{ Form::open(['route' => ['student.prblist.upload.exe',['type'=> 'masters']], 'method' => 'post', 'class'=> 'form-horizontal','files'=> true])}}
