<form class='form-horizontal' action="{{route('student.prblist.masters.store', ['type'=> 'masters_probable'])}}" data-form='postForm'>
    <div class="row">
        <div class="col-sm-6">
          ...
          <div class="form-group">
            {{ Form::label('current_level', 'Current Level', ['class' => 'col-form-label']) }}
              {!! Form::select('current_level', selective_multiple_masters_level(), $current_level ?? null, ['class'=>'form-control selectize','placeholder', 'data-plugin'=> 'selectpicker']) !!}
              <div class='invalid-feedback'></div>
          </div>
