...
@section('page-title', 'Degree Probable List Student Management')
...
<div class="panel">
	<header class="panel-heading">
	  <h3 class="panel-title">Upload Degree Probable List From CSV</h3>
	</header>
	...
	<div class="panel-body">
		...
		<div class="header-menu mb-5 d-flex justify-content-start">
			...
			{!! Form::hidden('type', 'degff') !!}
			<button class="btn btn-danger delete mr-1" type="submit"><i class="fas fa-trash"></i> Delete</button>
			{!! Form::close() !!}
			
    		<a href="{{route('download.csv.format', ['type'=> 'degff'])}}" class="btn btn-info"><i class="fas fa-file-csv"></i> Download Format</a>
		...
		<div class="row">
		  <div class="col-md-12">
	          	...
	          	{{ Form::open(['route' => ['student.prblist.upload.exe',['type'=> 'degree']], 'method' => 'post', 'class'=> 'form-horizontal','files'=> true])}}
