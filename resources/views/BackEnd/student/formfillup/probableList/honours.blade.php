...
@section('page-title', 'Honours Probable List Management')
...
<div class="panel">
        <header class="panel-heading">
          <div class="panel-actions">
            <a href="{{ route('student.prblist.upload', ['type'=> 'honours']) }}" class="btn btn-sm btn-info" data-label="Honours Probale Student"><i class="fas fa-upload"></i> Upload Batch Probable List</a>
            <a href="{{ route('student.prblist.create', ['type'=> 'honours']) }}" class="btn btn-sm btn-primary add_new" data-label="Honours Probable Student"><i class="fal fa-plus"></i> Add New Probable Student</a>
          </div>
        ...
        <div class="panel-body">
          ...
          <form class="form-inline d-flex justify-content-center">
            ...
            <div class="form-group">
              {!! Form::select('level', filter_empty_array(selective_multiple_honours_level()) ,null , ['class'=> 'form-control form-control-sm selectize filter', 'id' => 'current_level', 'data-placeholder' => '<--Level-->']) !!}
            </div>
...
$(document).ready(function() {
  datatable = $('#datatable').DataTable({
      ajax:{
        url: "{{ route('student.prblist.honours.datasource') }}",
        data: function (d) {
          d._token = "{{ csrf_token() }}",
