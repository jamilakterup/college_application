...
<div class="panel">
  <header class="panel-heading">
    <h3 class="panel-title">Student Migrations</h3>
  </header>
  <div class="panel-body">
      ...
      <div>
			 ...
			 @include('BackEnd.student.migration.particles.subMenuMigration')
      </div>
      <a href="{{ route('students.migration.exe') }}" class='btn btn-primary'><i class=''></i>Click Here For Migration </a>
		</div>

    <div class="col-md-12 d-flex justify-content-center">
      {!! Form::open(['route'=> 'students.migration.table', 'method'=> 'post', 'class' => 'form-inline']) !!}
        ...
        <div class="form-group">
          {!! Form::select('course', student_course_list(), $course, ['class' => 'form-control']) !!}
        </div>
    ...
    <table class="table table-hover defDTable w-full cell-border">
      ...
      <tbody>
        @foreach($migration_list as $college)
    ...
    {{ $migration_list->appends(Request::except('page'))->links() }}
