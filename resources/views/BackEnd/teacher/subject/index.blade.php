...
<div class="col-12">
    <div class="card">
        <div class="card-header align-items-center d-flex justify-content-between bg-light">
            <h4 class="card-title mb-0 flex-grow-1"><i data-feather="list" class="icon-md"></i>Subject Lists</h4>

            <button data-href="{{ route('teacher.subject-list.create') }}" data-action="create" onclick="getAjaxModalData(this, 'Add New Subject')" class="btn btn-primary">
...
@php
    ...
    $table_columns = [
        ...
        ['data'=> 'sub_name', 'className'=> 'text-center'],
...
@includeIf('common.datatable', [
    'datatable'=> $datatable,
    'url'=> route('teacher.subject-list.datasource'),
