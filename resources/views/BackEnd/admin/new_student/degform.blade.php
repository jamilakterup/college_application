...
@section('page-title', 'Add New Degree Student')
...
{!! Form::open(['route'=> 'admin.newstudent.degSubmit', 'method' => 'post', 'files'=> true]) !!}
<div class="col-md-12">
	<div class="card border border-primary">
	  ...
	  <div class="card-block">
		  ...
		  <div class="form-group row">
		    ...
		    <div class="col-sm-8">
			{!! Form::select('subject', selective_degree_subjects(), null, ['class' => 'form-control', 'required'=> true]) !!}
		  ...
		  <div class="form-group row">
		    <label for="religion" class="col-sm-4 col-form-label">Current Level</label>
			     <div class="col-sm-8">
				  {!! Form::select('current_level', selective_multiple_degree_level(), null, ['class' => 'form-control', 'required'=> true]) !!}
