<form class='form-horizontal' action="{{route('admin.admission.config.store')}}" data-form='postForm'>

  <div class="form-group">
    {{ Form::label('course', 'Course', ['class' => 'col-form-label']) }}

      {!! Form::select('course', student_course_list()+['masters_2nd'=> 'Masters Final'], $course ?? null, ['class' => 'form-control form-control-sm']) !!}
  ...
  <div class="form-group">
    {{ Form::label('type', 'Type', ['class' => 'col-form-label']) }}
      {!! Form::select('type', getEnumValues('admission_config', 'type'), $type ?? null, ['class' => 'form-control form-control-sm']) !!}
