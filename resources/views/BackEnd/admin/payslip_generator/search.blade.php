      	...
      	{{ Form::open(['route' => 'admin.payslip_item.search', 'method' => 'post']) }}
	      	<div class="row row-lg">
		        <div class="form-group col-md-6">
		          {!! Form::select('payslipheader_id', selective_multiple_payslip_header(), $payslipheader_id, ['class'=>'form-control payslipheader_id', 'autocomplete'=> 'off', 'data-plugin' => 'select2']) !!}
		        </div>
	    ...
	    <table class="table table-hover dataTable table-striped w-full cell-border">
	        ...
	        <tbody>
	            @foreach($payslip_items as $payslip_item)
					...
					<tr class="{{ Study::updatedRow('id', $payslip_item->id) }}">
