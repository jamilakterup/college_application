...
<body>
    <style>
        ...
        .sdudent-info td.border-bottom {
            border-bottom: 1px solid #333;
        }
    </style>
    <div class="invoice-table">
        <img src="{{ asset('img/rebmsc.png') }}" alt="" class="skcr-logo" height="100" />
        ...
        <div class="middle" style="float: left;width: 43%">
            <table width="100%" style="text-align:left; width:100%; margin-top:50px;">
                <tr>
                    <td width="100%" class="titles" style="text-align:center;">
                        <h2>Academic Transcript</h2>
                    </td>
                </tr>
                <tr>
                    <td width="100%" class="titles" style="text-align:center;">
                        <h3>{{$exam_name->name}}-{{date("Y")}}</h3>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <table class="sdudent-info" width="100%" style="text-align:left; width:100%; margin-top:10px;margin-bottom:15px;">
            <tr>
        ...
        <div class="table-left" style="width:100%; float:left;">
                    ...
                    <td style="text-align: center; padding:0px; padding-right: 0px; padding-left: 0px;">
                        ...
                        <table border="0" style="margin: 0; padding: 0;">
                            <tr style="border:0;margin: 0; padding: 0;">
                                <td style="font-size: 11px; padding: 0;">Above 2</td>
                            </tr>
                            <?php $zero = 0; ?>
                            @if($sub->absent!=1 && $sub->point>2)
                            <tr style=" padding:0px;border-left: 0; border-right: 0; border-bottom: 0; border-top: 0px; width: 100%; display: inline;">
                                <td style="padding: 0px;font-size: 11px;">---------------<br>{{$sub->point-2}}</td>
                            </tr>
                            @elseif($sub->absent!=1 && $sub->point<3)
                                <tr style="padding:0px;border-left: 0; border-right: 0; border-bottom: 0; border-top: 0px solid #ccc;">
                                <td style=" padding:0px;font-size: 11px;">---------------<br>{{$zero}}</td>
                </tr>
            ...
            <table width="100%">
                <tr style="text-align: right;">
                    <td width="70%">&nbsp;</td>
                    <td width="30%">
                        <img src="@php echo url('/');@endphp/img/principal_sign.png" alt="rebmsc logo" height="60">
                        <br />
                        ----------------------------
                    </td>
                </tr>
