...
<body>
    ...
    <div class="invoice-table">
        <?php $i = 1; ?>
        @foreach($hsc_temp as $info)

        <img src="{{ asset('img/college-logo.jpg') }}" alt="" class="icmraj-logo" style="width:70%; height: 100px; margin-left: 12%;">
        ...
        <div class="table-left" style="width:54%; float:left;">
            <table class="order-details" border="1" width="100%" style="margin-top:10px;">
                <tr>
                    ...
                    <td width="70%">{{$info->student_id}}</td>
                </tr>
                <tr>
                    <td>Student Name</td>
        ...
        <table width="100%">
            <tr style="text-align: right;">
                <td width="70%">&nbsp;</td>
                <td width="30%">
                    <!-- <img src="{{asset('img/principal_sig.png')}}"> -->
                    <br />----------------------------
                </td>
            </tr>
            <tr style="text-align: right;">
                <td width="70%">বিঃ দ্রঃ পরীক্ষা হলে কোন অবস্থাতেই মোবাইল ফোন আনা যাবেনা।</td>
                <td width="30%">Principal's Signature</td>
            </tr>

        </table>
        <div class="hr clear" style="height:30px; margin:0px 0px; margin-top:10px; clear:both;">&nbsp;</div>
        @if($i%2!=0)
