...
<div class="panel">
	<header class="panel-heading">
	  <h3 class="panel-title">Result Process Create</h3>
	</header>

	<div class="panel-body">
		<div class="row">
		  	<div class="col-md-12">
			  	{{ Form::open(['route' => 'hsc_result.process.store', 'method' => 'post', 'class'=> 'form-horizontal']) }}

		          	@include('BackEnd.hsc_result.process.particles.form')
