...
<div class="panel">
	<header class="panel-heading">
	  <h3 class="panel-title">Create Attendence Sheet</h3>
	</header>

	<div class="panel-body">
		<div class="row">
		  	<div class="col-md-12">
			  	{{ Form::open(['route' => 'hsc_result.attendance_sheet.list', 'method' => 'post', 'class'=> 'form-horizontal']) }}

		          	@include('BackEnd.hsc_result.attendance_sheet.particles.form')
