    ...
    <div>
      <div>
        <ul class="site-menu" data-plugin="menu">
          ...
          <li class="site-menu-item {{active('hsc_result/subject','hsc_result/subject/*', 'hsc_result/assign_subject*')}}">
          ...
          <li class="site-menu-item {{active('hsc_result/subject_info*','hsc_result/student_subject_assign*')}}">
