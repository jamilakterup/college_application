            ...
            <div class="col-md-12">
                ...
                <div class="mb-4">
                    <a href="{{ route('hsc_result.mark_input.mark_pdf', [
                        $session, $group, $curr_level->id, $exam_id, 
                        $subject_id, $exam_test_id, $exam_year
                    ]) }}" 
                       target="_blank" 
                    ...
                    <div class="float-right">
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" id="auto-save" checked {{$isDisabled ? 'disabled': null}}>
...
$(document).ready(function(){
    ...
    let columns = [
        ...
        { data: 'student_id', title: 'Student ID', name: 'student_id' },
        { data: 'student_name', title: 'Student Name', name: 'student_name' }
    ];
