...
@can('mark-entry.csv-upload')
<div class="submenu-item sub-menu">
	{{ link_to_route('hsc_result.mark_input.csv', 'CSV Upload', NULL, ['class' => 'btn btn-info']) }}
</div>
@endcan

<div class="panel">
	<header class="panel-heading">
	  <h3 class="panel-title">Mark Input Selection</h3>
	</header>

	<div class="panel-body">
		<div class="row">
		  	<div class="col-md-12">
			  	{{ Form::open(['route' => 'hsc_result.mark_input.list', 'method' => 'post', 'class'=> 'form-horizontal']) }}

		          	@include('BackEnd.hsc_result.mark_input.particles.form')
