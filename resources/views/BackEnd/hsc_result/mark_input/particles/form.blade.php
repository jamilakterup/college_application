...
<div class="form-group row">
  {{ Form::label('exam_test', 'Class Test', ['class' => 'col-md-2 form-control-label']) }}
  <div class="col-md-10">

    {{ Form::select('exam_test', $exam_tests, NULL, ['class' => 'form-control', 'id' => 'exam_test']) }}

    {!!invalid_feedback('exam_test')!!}
