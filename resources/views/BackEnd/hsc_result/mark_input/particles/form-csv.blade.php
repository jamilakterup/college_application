...
<div class="form-group row">
  {{ Form::label('subject_lebel', 'Subject', ['class' => 'col-md-2 form-control-label']) }}
  <div class="col-md-10">

    {{ Form::select('subject_id', $subject_lists, NULL, ['class' => 'form-control', 'id' => 'subject']) }}
...
<div class="form-group row">
  {{ Form::label('csv_file', 'CSV File', ['class' => 'col-md-2 form-control-label']) }}
  <div class="col-md-10">
    {{ Form::file('csv_file', NULL, ['class' => 'form-control']) }}

    {!!invalid_feedback('csv_file')!!}
...
<div class="form-group row">
  <div class="col-md-10 offset-md-2">
    ...
    <a href="{{ route('hsc_result.mark_input.index') }}" class="btn btn-warning btn-outline">Back</a>
  </div>
</div>