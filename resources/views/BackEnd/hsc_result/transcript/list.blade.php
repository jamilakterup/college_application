...
<div class="panel">
        ...
        <header class="panel-heading">
          <h3 class="panel-title">Transcript Generate Form ({{$session}} -> {{$group}} -> {{$curr_level->name}} -> {{$exam_name}} )</h3>
        </header>
			<div class="panel-body">
				{{ Form::open(['route' => 'hsc_result.transcript.store', 'method' => 'post']) }}
				...
				<div class='form-group'>
					<p class='para-type-b'>
						...
						i)  You can download maximum <span>50 students</span> Transcript at a time.
					</p>
				</div>
