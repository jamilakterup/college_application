...
<div class="form-group row">
  ...
  <div class="col-md-10">
    ...
    {{ Form::select('level', $level_list, NULL, ['class' => 'form-control year']) }}
...
<div class="form-group row">
  {{ Form::label('date', 'Publish Date', ['class' => 'col-md-2 form-control-label']) }}
  <div class="col-md-10">

    {{ Form::text('date', NULL, ['class' => 'form-control datepickr', 'id' => 'date']) }}

    {!!invalid_feedback('date')!!}
