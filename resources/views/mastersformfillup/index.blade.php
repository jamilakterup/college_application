    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse" id="navbar-collapsible">
            <ul class="nav navbar-nav navbar-left">
                <li><a href="#section2">Masters Form Fillup</a></li>
            </ul>
...
<section class="container-fluid one" id="section1">
    <div class="v-center">
        <h1 class="text-center"><span style='color:   #cf5713   ;'>Online Form Fillup</span><span> For Masters Student</span></h1>
    </div>
</section>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body row">
                ...
                <div class="col-md-10 col-md-offset-1 col-xs-12 col-xs-offset-0"  >
                    ...
                    <div class="form-group" >
                        @php
                            $config_levels = DB::table('form_fillup_config')->where('course', 'masters')->where('open', 1)->pluck('current_level', 'current_level');
                        @endphp
