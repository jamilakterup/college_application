...
<html>
<head>
	<title>Online Masters Application Form</title>
...
<body>
  ...
  <div class="container-fluid">
    ...
    <a href="<?php echo url('/').'/Admission/Masters/signin'?>" class="btn btn-danger navbar-btn">Login</a>
  </div>
</nav>
      ...
      ?>
  		...
  		<div class="col-md-12">
		    <div class="panel panel-info">
		      ...
		      <div class="panel-body bg-success" style="font-size:18px;"><?php echo 'Your Ref Id :'.' '.session::get('tracking_id').' '. 'And Password:'.' '.Session::get('password').' '.'Please remember your Ref Id and password for login. You need to login several time for admission purpose';?>  </div>
		    </div>
	    </div>
    </div>
    <?php } ?>
   <form action="{{route('student.masters.admission.mscAdmInformationSubmit')}}" method="POST" enctype="multipart/form-data">
   	@csrf
    ...
    <div class="row mb">
      <div class="col-md-12">
	    <div class="panel panel-primary">
	    	<div class="panel-heading">Honours Information</div>
	      <div class="panel-body">
	         ...
	         <div class="form-group">
	              ...
	              <div class="form-group">
							...
							<tr><td>Honours Roll</td> <td><input type="text" name="honours_roll" value="<?php echo $hons_roll ?>"  class="form-control" readonly></td><tr>
							</table>
	...
	@php
	$config = DB::table('admission_config')->where('open', 1)->where('current_level', 'Masters 2nd Year')->where('course', 'masters')->where('type', 'admission')->where('type', 'admission')->first();
	@endphp
    <div class="row mb">
      <div class="col-md-12">
	    <div class="panel panel-primary">
	      ...
	      <div class="panel-body">
	         ...
	         <div class="form-group">
	              ...
	              <div class="form-group">
							...
							<tr>
							<tr>
								<td> <input type="text" name="to_faculty" value="<?php echo $admit_faculty; ?>"  class="form-control" readonly></td>
								<td> <input type="text" name="to_subject" value="<?php echo $admit_subject; ?>"  class="form-control" readonly></td>
								<td> <input type="text" name="msc_session" value="<?php echo $config->session; ?>"  class="form-control" readonly></td>
							</tr>
							</table>
			    ...
			    <div class="panel-body">
                  ...
                  {!! Form::file('photo', ['class'=> 'form-control', 'id'=> 'photo', 'required'=> true]) !!}
						  ...
						  <div class="form-group">
						    ...
						    <div class="col-sm-8">
						      {!! Form::text('father_name', $father_name, ['class'=> 'form-control', 'id'=> 'father_name', 'required'=> true, 'placeholder' => "Father's Name"]) !!}
						      <div class="help-block"></div>
						    </div>
						  ...
						  <div class="form-group">
						    ...
						    <div class="col-sm-8">
						      {!! Form::text('mother_name', $mother_name, ['class' => 'form-control', 'placeholder' => "Mother's Name" , 'required' => true, 'id' => 'mother_name']) !!}
