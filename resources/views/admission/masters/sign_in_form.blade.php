...
<body>
  ...
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="#">{{config('settings.college_name')}} Masters Online Admission</a>
    </div>
             ...
             <center>
                ...
                <div class="panel panel-primary "  >
                  ...
                  <div class="panel-body">
                        ...
                        <div class="col-sm-12">               
                         <div class="form-group">
                        <label>Hons Roll</label>
                            <input type="text" id="text1"  class="form-control hons_roll"   placeholder="Type your Hons roll">
                            <div class="help-block"></div>
                            </div>
                            </div>
                        </div> 
    ...
    <script type="text/javascript">
      ...
      $('document').ready(function(){
            ...
            $('#retrieve_passsword').click(function(){
                ...
                var hons_roll =$('.hons_roll').val();

                $.ajax({
                    type:'POST',
                    url:'retrievepass',
                    data:{admission_roll:admission_roll,hons_roll:hons_roll},
