  ...
  <body >
    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <p class="navbar-brand" href="#section1"><span style='color:   #cf5713;'>{{config('settings.college_name')}} {{config('settings.college_name') !='' ? ', '.config('settings.college_district'):''}}</span> <span style='color:   white;'>Masters Part-1 Online Admission</span></p>
        </div>
        <div class="navbar-collapse collapse" id="navbar-collapsible">
            <ul class="nav navbar-nav navbar-left">
                <li><a href="#section2">Login</a></li>
                <li><a href="<?php echo url('/').'/Admission/Masters1st/signin'?>" class=""><i class=''></i>Signin</a></li>
...
<section class="container-fluid one" id="section1">
    <div class="v-center">
        <h1 class="text-center"><span style='color:   #cf5713   ;'>Online Admission</span><span> For Masters Part-1 Student</span></h1>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h2 class="text-center"><img src="" class="img-circle"><br>Masters Part-1 Admission</h2>
            </div>
            <div class="modal-body row">
                <h6 class="text-center">COMPLETE THESE FIELDS FOR ADMISSION</h6>
                <div class="col-md-10 col-md-offset-1 col-xs-12 col-xs-offset-0">
                    <div class="form-group">
                        {!! Form::text('msc_roll', null, ['class'=> 'form-control input-lg', 'placeholder'=> 'Admission Roll', 'required'=> true, 'id'=> 'msc_roll' ]) !!}
                    </div>
                    <div style="margin:0 auto;font-size:18px; text-align:center;" id="next_step_error"></div>

                    <div class="form-group">
                        <button class="btn btn-danger btn-lg btn-block" id="honours_admission_step">Next</button>
                    </div>
                </div>
            </div>
