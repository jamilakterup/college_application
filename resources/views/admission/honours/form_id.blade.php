...
<head>
    ...
    <title>Honours Admission Form</title>
    ...
    <header class="clearfix">
        ...
        <div class="header-content clearfix">
            <div class="left">
                ...
                <h4>Honours Admission Form</h4>
                <h4>Session : {{$student->session}}</h4>
            </div>
            <div class="right">
                <p>{{$student->dept_name}}</p>
                <p>Class Roll: {{(int) $student->class_roll}}</p>
            </div>
        </div>
    </header>
    ...
    <section class="personal-info clearfix" style="margin-top: -15px;">
        ...
        <div class="right">
            <div class="profile-img">
                <img style="margin-top: 9px" class="user_pic_view" height="130px" width="130px" src="{{ asset('upload/college/honours/'.$student->session.'/'. $student->image) }}" alt="User Photo" /> 
            </div>
            <div class="content" style="margin-top: 10px;">
                ...
                <table class="right-info" style="margin-top: 74px;">
                    <tr>
