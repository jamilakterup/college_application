...
<html>
  <head>
    <meta charset="utf-8">
    <title>Online Honours Admission</title>
    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse" id="navbar-collapsible">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<?php echo url('/').'/Admission/Honours/signin'?>" class=""><i class=''></i>Signin</a></li>
            </ul>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h2 class="text-center"><img src="" class="img-circle"><br>Honours Admission</h2>
            </div>
