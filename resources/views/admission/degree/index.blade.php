...
<html>
  <head>
    <meta charset="utf-8">
    <title>Online Degree Admission</title>
    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse" id="navbar-collapsible">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<?php echo url('/').'/Admission/Degree/signin'?>" class=""><i class=''></i>Signin</a></li>
...
<section class="container-fluid one" id="section1">
    <div class="v-center">
        <h1 class="text-center"><span style='color:   #cf5713   ;'>Online Admission</span><span> For Degree Student</span></h1>
...
<div id="myModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h2 class="text-center"><img src="" class="img-circle"><br>Degree Admission</h2>
            </div>
    ...
    <!--scripts loaded here-->
  	...
  	<script src="{{ asset('fjs/degree_admission.js') }}"></script>
  </body>
</html>