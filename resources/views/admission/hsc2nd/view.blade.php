        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse" id="navbar-collapsible">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="<?php echo Url('/'); ?>/HSC/2nd/Admission">HSC 2nd Year Online Admission</a></li>
                </ul>
            </div>
        </div>
    </nav>
                        ...
                        <div class="col-sm-12 text-center">
                            <div class="panel panel-primary slideInLeft animate">
                                ...
                                <div class="panel-body">
                                    <h4>আপনার Form FillUp প্রক্রিয়া সফলভাবে সম্পন্ন হয়েছে । <br> নিচের লিংক থেকে
                                        কনফার্মেশন স্লিপ ডাউনলোড করতে পারেন । <br /><br />
                                        <a id="confirm_slip" style="cursor:pointer;"><span
                                                style='color:#673AB7;'>Download Confirmation Slip</span></a>
                                    </h4>
