...
<head>
    <meta charset="utf-8">
    <title>HSC 2nd Year Admission</title>
...
<body>
    <nav class="navbar navbar-trans navbar-fixed-top" role="navigation">
        <div class="container">
            <div class="navbar-header">
                ...
                <p class="navbar-brand" href="#section1"><span
                        style='color:   #cf5713;'>{{ config('settings.college_name') }}</span> <span
                        style='color:   white;'>HSC 2nd Year Online Admission</span></p>
            </div>
            <div class="navbar-collapse collapse" id="navbar-collapsible">
                <ul class="nav navbar-nav navbar-left">
                    <li><a href="#section2">HSC 2nd Admission</a></li>
                </ul>
    ...
    <section class="container-fluid one" id="section1">
        <div class="v-center">
            <h1 class="text-center"><span style='color:   #cf5713   ;'>Online 2nd Year Admission</span><span> For HSC
                    Student</span></h1>
        </div>
    </section>
    ...
    <section class="container-fluid two" id="section2">
        <div class="container">
                        ...
                        <div class="col-sm-12 text-center">
                            <div class="panel panel-primary slideInLeft animate">
                                <div class="panel-heading">
                                    <h3>{{ config('settings.college_name') }}</h3>
                                </div>
                                <div class="panel-body">
                                    <img src="{{ asset('upload/sites/' . config('settings.site_logo')) }}" alt=""
                                        class="footer-logo">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12 text-center">
                            <div class="panel panel-primary slideInUp animate">
                                <div class="panel-heading">
                                    <h3>গুরত্বপূর্ণ নির্দেশাবলীঃ</h3>
                                </div>
                                <div class="panel-body">
                                    <h4>এই ওয়েবসাইটের মাধ্যমে Admission সম্পন্ন করার জন্য নিম্নের তথ্যগুলি অত্যাবশ্যকঃ
                                    </h4>
                                    <hr>
                                    <h4>Class Roll</h4>
                                    <h4>Level</h4>
            ...
            <div class="row">
                <p class="text-center">
                    <br>
                    <a href="#" class="btn btn-blue btn-lg btn-huge lato" data-toggle="modal"
    ...
    <div id="myModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h2 class="text-center"><img src="" class="img-circle"><br>HSC 2nd Year Admission</h2>
                </div>
                <div class="modal-body row">
                    <h6 class="text-center">COMPLETE THESE FIELDS TO ADMISSION</h6>
                    <div class="col-md-10 col-md-offset-1 col-xs-12 col-xs-offset-0">
                        <div class="form-group">
                            <input type="text" id="student_id" class="form-control input-lg"
                                placeholder="Class Roll" required>
                        </div>

                        <div class="form-group">
                            @php
                                $config_levels = DB::table('admission_config')
                                    ->where('course', 'hsc')
                                    ->where('open', 1)
                                    ->pluck('current_level', 'current_level');
                            @endphp
                            {!! Form::select('current_level', $config_levels, null, [
        ...
        <div id="admission_step_modal" class="modal hide fade" tabindex="-1" role="dialog"
    ...
    <script src="{{ asset('fjs/hsc2nd_adm.js') }}"></script>
</body>
