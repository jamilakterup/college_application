...
<head>
    ...
    <title>{{ $adm_student->level_study }} Admission Confirmation Slip</title>
...
<body>
    <div class="slip">
        ...
        <section class="main-content">
            <h2 style="margin: 2px 0;">{{ $adm_student->level_study }} Admission Confirmation Slip</h2>
            <table>
                <tr>
                    <td class="info-label">Name</td>
                    <td>{{ $adm_student->name }}</td>
                </tr>

                <tr>
                    <td class="info-label">Registration ID</td>
                    <td>{{ $adm_student->id }}</td>
                </tr>

                <tr>
                    <td class="info-label">Form Fillup Level</td>
                    <td>{{ $adm_student->level_study }}</td>
                </tr>
                <tr>
                ...
                {{--                 <tr>
                    ...
                    <td>{{$adm_student->exam_year}}</td>
                </tr> --}}

                <tr>
                    <td class="info-label">Transaction ID</td>
                    <td>{{ $adm_student->transaction_id }}</td>
                </tr>

                <tr>
                    <td class="info-label">Paid Amount</td>
                    <td>{{ $adm_student->total_amount }}</td>
                </tr>

                <tr>
                    <td class="info-label">Payment Date</td>
                    <td>{{ $adm_student->date }}</td>
                </tr>
            </table>
        </section>
