        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <p class="navbar-brand"><span style='color:   #cf5713;'>{{ config('settings.college_name') }}</span>
                    <span style='color:   white;'>HSC 2nd Year Online Admission</span>
                </p>
            ...
            <div class="navbar-collapse collapse" id="navbar-collapsible">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="/HSC/2nd/Admission">HSC 2nd Year Online Admission</a></li>
                </ul>
            </div>
        </div>
    </nav>
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body ">
                            @php
                                ...
                                $payment_guideline = get_config('hsc2nd_adm_payment_guideline');

                                if ($payment_guideline) {
                                    echo @configTempleteToBody($payment_guideline, ['student_id' => $student_id, 'college_name_bn' => $college_name_bn, 'biller_id' => $biller_id, 'total_amount' => round($payment_amount)]);
                                }
                            @endphp
                            <div class="row text-center">
                                <button class="btn btn-primary text-center" onClick="window.location.reload();">Confirm
                                    To Download Confirmation Slip</button>
                            </div>
                        </div>
                    </div>
                </div>
