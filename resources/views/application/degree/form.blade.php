...
<div class="container">
	<div class="panel-group">
		...
		{!! Form::open(['route'=> 'student.degree.application.degAppInformationSubmit', 'method' => 'post', 'files' => true, 'class'=> 'form-horizontal']) !!}
			    	...
			    	<div class="panel-heading">Student Data</div>
			      	<div class="panel-body">
			       		...
			       		<div class="form-group">
			       			...
			       			<div class="col-sm-10">
			       				{!! Form::select('dept_name', selective_degree_subjects(), null, ['class'=> 'form-control select2', 'required'=> true]) !!}
