...
<head>
    ...
    <title>Honours 2nd Year Admission Confirmation Slip</title>
    ...
    <div class="slip">
        <header class="clearfix">
            ...
            <div class="header-content">
                <p style="font-weight: bold;font-size: 18px; line-height: 22px" >{{config('settings.college_name')}} {{config('settings.college_name') !='' ? ', '.config('settings.college_district'):''}}</p>
        ...
        <section class="main-content">
            <h2 style="margin: 2px 0;">Honours 2nd Year Admission Confirmation Slip</h2>
            <table>
                <tr>
