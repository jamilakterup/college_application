...
<html>
  <head>
    <meta charset="utf-8">
    <title>Honours 2nd Year Admission</title>
  ...
  <body >
    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <p class="navbar-brand" href="#section1"><span style='color:   #cf5713;'>{{config('settings.college_name')}}</span> <span style='color:   white;'>Online Honours 2nd Year Admission</span></p>
        </div>
        <div class="navbar-collapse collapse" id="navbar-collapsible">
            <ul class="nav navbar-nav navbar-left">
                <li><a href="#section2">Admission</a></li>
            </ul>
...
<section class="container-fluid one" id="section1">
    <div class="v-center">
        <h1 class="text-center"><span style='color:   #cf5713   ;'>Online Admission</span><span> For Honours Student</span></h1>
    </div>
</section>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h2 class="text-center"><img src="" class="img-circle"><br>Honours 2nd Year Admission</h2>
            </div>
            <div class="modal-body row">
                <h6 class="text-center">COMPLETE THESE FIELDS FOR REGISTRATION</h6>
                <div class="col-md-10 col-md-offset-1 col-xs-12 col-xs-offset-0"  >
                    <div class="form-group">
                        {!! Form::text('admission_roll', null, ['class'=> 'form-control input-lg', 'placeholder'=> 'Class Roll', 'required'=> true, 'id'=> 'admission_roll' ]) !!}
                    </div>
