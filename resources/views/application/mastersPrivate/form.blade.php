...
<html>
<head>
	<title>Online Masters Private Registration Form</title>
...
<div class="container">
	<div class="panel-group">
		...
		{!! Form::open(['route'=> 'student.masters.private.reg.mscAppInformationSubmit', 'method' => 'post', 'files' => true, 'class'=> 'form-horizontal']) !!}
			    	...
			    	<div class="panel-heading">Student Data</div>
			      	<div class="panel-body">
			       		...
			       		<div class="form-group">
			       			...
			       			<div class="col-sm-10">
				       			{!! Form::text('father_name', null, ['class' => 'form-control', 'id'=> 'father_name', 'placeholder'=> 'Please Enter Your Full Name', 'required'=> true]) !!}
			       		...
			       		<div class="form-group">
			       			...
			       			<div class="col-sm-10">
			       				{!! Form::select('dept_name', selective_masters_subjects(), null, ['class'=> 'form-control select2', 'required'=> true]) !!}
