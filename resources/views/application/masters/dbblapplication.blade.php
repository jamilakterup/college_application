...
<body>
  ...
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="#">{{config('settings.college_name')}} Masters Online Application</a>
    </div>
    <a href="<?php echo url('/').'/Application/Masters' ?>" class="btn btn-danger navbar-btn">Application</a>
    <a href="<?php echo url('/').'/Application/Masters/logout'?>" class="btn btn-danger navbar-btn">Logout</a>
  </div>
</nav>
            ...
            <div class="panel-body">
              ...
              @if($payment_status!="Paid")
                ...
                @php
                    ...
                    $payment_guideline = get_config('msc_application_payment_guideline');
