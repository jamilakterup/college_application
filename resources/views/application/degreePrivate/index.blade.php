...
<html>
  <head>
    <meta charset="utf-8">
    <title>Online Degree Private Registration</title>
  ...
  <body >
    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <p class="navbar-brand" href="#section1"><span style='color:   #cf5713;'>{{config('settings.college_name')}}</span> <span style='color:   white;'>Online Degree Private Registration</span></p>
        </div>
...
<section class="container-fluid one" id="section1">
    <div class="v-center">
        <h1 class="text-center"><span style='color:   #cf5713   ;'>Online Registration</span><span> For Degree Private Student</span></h1>
    </div>
</section>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h2 class="text-center"><img src="" class="img-circle"><br>Degree Private Registration</h2>
            </div>
