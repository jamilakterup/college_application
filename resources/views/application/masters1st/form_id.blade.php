...
<head>
    ...
    <title>Masters Preliminary to Masters Application Form</title>
    ...
    <header class="clearfix">
        ...
        <div class="header-content clearfix">
            <div class="left">
                ...
                <h4>Masters Part-1 Application Form</h4>
                <h4>Session : {{$admitted_student->session}}</h4>
            </div>

            <div class="right">
                <p>Admission Roll: {{$admitted_student->admission_roll}}</p>
            </div>
        </div>
    </header>
    ...
    <section class="personal-info clearfix" style="margin-top: -15px;">
        ...
        <div class="right">
            <div class="profile-img">
                <img style="margin-top: 9px" class="user_pic_view" height="130px" width="130px" src="{{ asset('upload/college/masters/draft/'. $admitted_student->photo) }}" alt="User Photo" /> 
            </div>
