...
<body>
  ...
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="#">{{config('settings.college_name')}} Masters Part-1 Online Application</a>
    </div>
    <a href="<?php echo url('/').'/Application/Masters' ?>" class="btn btn-danger navbar-btn">Application</a>
    <a href="<?php echo url('/').'/Application/Masters/signin'?>" class="btn btn-danger navbar-btn">Signin</a>
  </div>
</nav>
