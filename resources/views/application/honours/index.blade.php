  ...
  <body >
    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <p class="navbar-brand" href="#section1"><span style='color:   #cf5713;'>{{config('settings.college_name')}}</span> <span style='color:   white;'>Online Application Honours</span></p>
        </div>
        <div class="navbar-collapse collapse" id="navbar-collapsible">
            <ul class="nav navbar-nav navbar-left">
                <li><a href="#section2">Application</a></li>
                <li><a href="<?php echo url('/').'/Application/Honours/signin'?>" class=""><i class=''></i>Signin</a></li>
...
<section class="container-fluid one" id="section1">
    <div class="v-center">
        <h1 class="text-center"><span style='color:   #cf5713   ;'>Online Application</span><span> For Honours Student</span></h1>
    </div>
</section>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h2 class="text-center"><img src="" class="img-circle"><br>Honours Applicaton</h2>
            </div>
            <div class="modal-body row">
                <h6 class="text-center">COMPLETE THESE FIELDS FOR APPLICATION</h6>
