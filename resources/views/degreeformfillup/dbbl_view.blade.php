        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <p class="navbar-brand"><span style='color:   #cf5713;'>{{ config('settings.college_name') }}</span>
                    <span style='color:   white;'>Degree Online Form Fillup</span>
                </p>
            ...
            <div class="navbar-collapse collapse" id="navbar-collapsible">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="/Degree/formfillup">Degree Online Form Fillup</a></li>
                </ul>
            </div>
        </div>
    </nav>
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            @php
                                ...
                                $payment_guideline = get_config('degree_ff_payment_guideline');
