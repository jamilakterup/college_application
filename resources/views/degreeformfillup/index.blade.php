  ...
  <body >
    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <p class="navbar-brand" href="#section1"><span style='color:   #cf5713;'>{{config('settings.college_name')}}</span> <span style='color:   white;'>Degree Online Form Fillup</span></p>
        </div>
        <div class="navbar-collapse collapse" id="navbar-collapsible">
            <ul class="nav navbar-nav navbar-left">
                <li><a href="#section2">Degree Form Fillup</a></li>
...
<section class="container-fluid one" id="section1">
    <div class="v-center">
        <h1 class="text-center"><span style='color:   #cf5713   ;'>Online Form Fillup</span><span> For Degree Student</span></h1>
    </div>
</section>
...
<div id="myModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h2 class="text-center"><img src="" class="img-circle"><br>Degree Form Fillup</h2>
            </div>
            <div class="modal-body row">
                ...
                <div class="col-md-10 col-md-offset-1 col-xs-12 col-xs-offset-0"  >
                    ...
                    <div class="form-group" >
                        @php
                            $config_levels = DB::table('form_fillup_config')->where('course', 'degree')->where('open', 1)->pluck('current_level', 'current_level');
                        @endphp
    ...
    <script src="{{ asset('fjs/degreeff.js') }}"></script>
  </body>
</html>