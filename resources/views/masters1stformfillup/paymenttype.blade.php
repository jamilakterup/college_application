      ...
      <a href="<?php echo url('/').'/Masters1st/formfillup/logout'?>" class="btn btn-danger navbar-btn">Logout</a>
        ...
        <div class="navbar-collapse collapse" id="navbar-collapsible">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li><a href="/Masters/formfillup">Preli to Masters Form Fillup</a></li>
            </ul>
        </div>
    </div>
</nav>
  ...
  <div class="row">
    <div class="col-md-10 col-md-offset-1">
      ...
      <select  id="payType" required="required" name="payType" class="form-control preferenceSelect">
        ...
        $results = DB::select("select * from payslipheaders where pro_group='masters' and level='$current_level' and type='formfillup'  and  exam_year = '$examyear' and session = '$session' and formfillup_type ='improvement' and total_papers <= '$total_papers'");
...
<div class="scroll-up">
    ...
    <!--scripts loaded here-->
     ...
     <script src="<?php  echo url('/') ?>/fjs/masters1stff.js"></script>
<!-- 
