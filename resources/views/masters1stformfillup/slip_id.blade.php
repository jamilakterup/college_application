...
<head>
    ...
    <title>Preli to Masters Form Fillup Confirmation Slip</title>
...
<body>
    <div class="slip">
        ...
        <section class="main-content">
            <h2 style="margin: 2px 0;">Preli to Masters Form Fillup Confirmation Slip</h2>
            <table>
                <tr>
                ...
                <tr>
                    ...
                    <td>{{ucfirst($ff_student->student_type)}}</td>
                </tr>
